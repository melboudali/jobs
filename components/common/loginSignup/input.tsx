					...
					<button
						...
						{showPassword ? (
							<svg width="24" height="24" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<path fillRule="evenodd" clipRule="evenodd" d="M20.469 21.531L2.46899 3.53099L3.53099 2.46899L21.531 20.469L20.469 21.531Z" />
							</svg>
						) : (
